      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            />
            <div className="neuron-card">
              <h2 className="text-sm font-semibold text-gray-400 mb-3">Waterfall Analysis</h2>
              <WaterfallChart
                items={[
                  { label: 'Decision Cycle Time', value: metric.decision_cycle_time_hours, color: '#f59e0b', suffix: 'h' },
                  { label: 'Info Half-Life', value: metric.info_half_life_hours, color: '#00b8f0', suffix: 'h' },
                  { label: 'Execution Velocity', value: metric.execution_velocity * 100, color: '#10b981', suffix: '%' },
                ]}
